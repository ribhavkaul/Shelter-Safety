...
public class HomeOwnershipSecurity {
    public static void main(String[] args) {
        ...
        final double HOME_APPRECIATION = 0.025;
        ...
        if (!trouble) {
            ...
            System.out.print("This is conservative as home values tend to appreciate at an average rate of over 4.6%");
            System.out.println(" annually,\nwhich is more than the 2.5% estimation that was put in this program:");
            System.out.print("https://www.neighborhoodscout.com/ca/san-jose/real-estate");
        }
        input.close();
    }
}